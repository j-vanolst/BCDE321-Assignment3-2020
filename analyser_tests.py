...
class TestAnalyser(unittest.TestCase):
    ...
    def test_analyser_get_filenames(self):
        ...
        expected = ['package/sample-es6/src/js\\drag.js', 'package/sample-es6/src/js\\html.js',
                    'package/sample-es6/src/js\\main.js', 'package/sample-es6/src/js\\utils.js']
        self.assertEqual(result, expected)
    ...
    def test_class_model_get_methods(self):
        ...
        expected = ['constructor(base)', 'constructor(base)',
                    'createContainer()', 'htmlTest()', 'constructor()', 'baseTest()']
        self.assertEqual(result, expected)
